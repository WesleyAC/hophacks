...
demo_data_b = AvgData(rawdata, datetime(2017, 5, 30, 0, 0, 0), timedelta(1))
demo_data_b.fudge(-20,-0.35)
demo_data_c = AvgData(rawdata, datetime(2017, 5, 25, 0, 0, 0), timedelta(1))
demo_data_c.fudge(-100)
